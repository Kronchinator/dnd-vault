...
## Description
Nobody knows his real name. The title is all that's given — a reference to the silhouette seen over the Ravendeer coastal estate the morning it burned. Massive, scaled, serpentine wings banking through smoke before disappearing into clouds.

He is dragonborn, and he does the serious work. Corvin Fels handles administration. Brek handles enforcement. The Ashwing handles the things neither of them is built for.

He is rarely seen in person. That is by design.
