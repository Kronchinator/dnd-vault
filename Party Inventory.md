...
## Story Items
These items have narrative significance. Track them carefully.
...
| [[The Promissory Ring]] | Aeritch | Names inside; tightens on false promises |
| Rooflane's spellbooks | Aeritch | Contents largely unread |

---

## Session 1 Loot
*From the fight at the Tillerman's Rest.*

| Item | Status | Notes |
|---|---|---|
| Enforcer scimitars ×3 | Unclaimed | 1d6+2 slashing, worth ~10gp each if sold |
| Enforcer leather armour ×3 | Unclaimed | AC 11+DEX, worth ~10gp each if sold |
| Enforcer coin | Unclaimed | ~3d6 copper per enforcer |
| Brek's heavy crossbow | Unclaimed | 1d10+1 piercing, range 100/400 — worth 50gp |
| Brek's coin | Unclaimed | ~2d6 silver |
...
*Significant personal items not in the story items list.*
...
## Mundane Items
*Grabbed from the environment. Don't track candles and rope individually — just note if something was specifically taken.*
