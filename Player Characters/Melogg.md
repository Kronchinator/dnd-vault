...
name: Melogg
player: 
race: Cursed Golem (Homebrew)
class: Barbarian
level: 1
subclass: (Primal Path — chosen at level 3)
background: 
tags: [player-character, barbarian, golem, homebrew]
---

# Melogg
*Level 1 Cursed Golem Barbarian*
...
### Saving Throws
- Strength (proficient) +4
- Constitution (proficient) +5
...
- **[[Rage]]** — Bonus action. Lasts 1 minute. Advantage on STR checks and saves, +2 damage on melee STR attacks, resistance to bludgeoning/piercing/slashing damage. **2 uses per long rest.**
- **Unarmored Defense** — *Overridden by Iron Frame. Would be 10 + DEX + CON = 13; Iron Frame (16) is strictly better.*
...
| Item | Notes |
|------|-------|
| Javelins ×4 | 1d6 piercing, thrown 30/120 ft |
| Explorer's Pack | Backpack, bedroll, mess kit, tinderbox, 10 torches, 10 days rations, waterskin, 50 ft hempen rope |

> ⚠️ No melee weapon listed beyond javelins — Barbarians typically carry a greataxe or two handaxes. Confirm with player.
